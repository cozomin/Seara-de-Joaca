-- CREATE USER cosmin WITH ENCRYPTED PASSWORD 'cosmin';
-- GRANT ALL PRIVILEGES ON DATABASE cti TO cosmin ;
-- GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO cosmin;
-- GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO cosmin;
